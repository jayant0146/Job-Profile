...
// files imports
import connectDB from "./config/db.js";  //need to mention the .js extension too
// routes import
...
//validation middelware: If written before then will not exeute the remaining part
